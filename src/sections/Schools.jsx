...
import { SchoolData } from "../components/content/Content";
import {
  FaChevronRight,
  FaChevronLeft,
  FaHandPointRight,
...
const Schools = () => {
  ...
  useEffect(() => {
    const handleHashChange = () => {
      if (window.location.hash === "#schools" && scrollRef.current) {
          ...
          >
            <div className="ml-6 sm:ml-12 lg:ml-24 flex h-screen justify-center flex-col items-start shrink-0 w-[16rem] sm:w-[20rem]">
              ...
              <p className="mt-4 lg:mt-6 text-md sm:text-lg w-11/12 mb-36 whitespace-pre-wrap">
                The educational odyssey of PSG & Sons' Charities embarked with
                PSG Sarvajana School and subsequently flourished into multiple
                branches across the city. This growth symbolises their
                commitment to empowering through quality education, enriching
