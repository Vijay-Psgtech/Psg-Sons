      ...
      <div className="overflow">
        <div className="flex justify-center relative items-center h-[100dvh] w-full">
          ...
          <img
            ...
            width={430}
            height={567}
            className="absolute hover:grayscale h-[22.5rem] transition-all grayscale-0 cursor-pointer w-46 md:w-[21rem] bottom-0 left-0 md:left-24 z-10"
            src="/images/founder.jpg"
            onClick={() => handleDrawerClick()}
          />

          
          <div className="mt-1 overflow-visible w-9/12 my-41 md:w-1/3">
            <div className="relative z-10 text-gray-900 px-4">
              ...
              >
                <img
                  ...
                  width={91}
                  height={123}
                  className="bottt h-[25.grem] drop-shadow-xl absolute md:-left-36 -left-12 md:-top-12 top-6 hidden md:block"
                  src="/images/quote.svg"
                />
                Let there be{" "}
