  ...
  return (
    <AnimatedSection bgImage="/images/bg2.webp">
      ...
      <div className="relative z-10 text-gray-900 px-4">
        <p className="text-sm md:text-md tracking-wide md:tracking-widest uppercase font-semibold text-center">Chapter 4</p>
