...
const Colleges = () => {
  ...
  useEffect(() => {
    const handleHashChange = () => {
      if (window.location.hash === "#colleges" && scrollRef.current) {
          ...
          >
            <div className="ml-6 sm:ml-12 lg:ml-24 flex h-screen justify-center flex-col items-start shrink-0 w-[16rem] sm:w-[20rem]">
              ...
              <p className="mt-4 lg:mt-6 text-md sm:text-lg w-11/12 mb-36 whitespace-pre-wrap">
                Over the span of numerous decades, Coimbatore has consistently
                remained the preferred educational hub for students from across
                Tamil Nadu seeking higher education opportunities. This
                prominence can be attributed to the establishment of a range of
                PSG Institutions, covering disciplines including Arts,
                Management, Engineering, and many more.
              </p>
