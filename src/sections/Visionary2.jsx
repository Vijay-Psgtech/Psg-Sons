    ...
    <AnimatedSection bgImage="/images/bg2.webp">
      ...
      <div className="relative z-10 text-gray-900 px-4">
        ...
        <p className="w-10/12 md:w-3/4 lg:w-1/2 mx-auto mt-4 md:mt-16 text-justify md:text-center text-base md:text-lg font-medium text-gray-800">
          PS Govindaswamy Naidu, the second son of Sama Naidu, emerged as a
          visionary committed to charitable initiatives in his village.
          Inheriting both fertile and dry land, he engaged in trading cotton,
          earning respect within the trading community. PS Govindaswamy Naidu's
          leadership extended beyond commerce, as he championed piety and
          charitable values. The name PSG, representing 'Periya Veedu,' 'Sama
          Naidu,' and 'Govindaswamy Naidu,' symbolizes the enduring legacy of
