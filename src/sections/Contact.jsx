...
import { publicationData } from "../components/content/Content";
    ...
    <div className="section h-[100dvh]" onMouseMove={handleMouseMove}>
      <div className="overflow">
        <div className="flex relative flex-col  text-center justify-center items-center h-[100dvh] w-full">
          ...
          <div
            className={`${!openModal && "relative z-10 text-gray-900 px-4"}`}
          >
            ...
            <p className="mt-4 md:mt-6 w-10/12 mx-auto">
              For further assistance or information, kindly get in touch with
              us.
            </p>
            <div className="mt-4 md:mt-8">
              ...
              <div className="flex gap-6 mt-8 justify-center items-center mx-auto flex-wrap">
                <div className="bg-white border border-slate-300 hover:bg-white hover:text-black anim relative font-semibold p-4 md:p-6 px-8 md:px-12 w-11/12 md:w-fit rounded-xl shadow-md">
                  <a target="_blank" href="mailto:charity@psgtech.edu">
                    charity@psgtech.edu
                  </a>
                ...
                <div className="bg-white border border-slate-300 hover:bg-white hover:text-black anim relative font-semibold p-4 md:p-6 px-8 md:px-12 w-11/12 md:w-fit rounded-xl shadow-md">
                  <a target="_blank" href="tel:04222572265">
                ...
                <div className="bg-white border border-slate-300 hover:bg-white hover:text-black anim relative font-semibold p-4 md:p-6 px-8 md:px-12 w-11/12 md:w-fit rounded-xl shadow-md">
                  <a href="/privacy-policy">
                    <button className="cursor-pointer">Disclosures</button>
                  </a>
          ...
          {openModal && (
            ...
            >
              <div className="flex flex-col justify-center items-center toppppp gap-8 drop-shadow-2xl rounded-2xl z-10 h-[80vh] w-[60vw]">
                  ...
                  {publicationData.map((pub, idx) => (
                    <div key={pub.title} className="w-full h-full">
                      ...
                      >
                        {pub.title}
                        <br />
                        <span className="text-xs md:text-sm mt-1 block text-center opacity-50">
                          {pub.date}
                        </span>
                      </a>
                    </div>
                ...
                <button
                  className="absolute toppppp pointer-events-auto bg-red-500 ring-white ring-2 text-sm text-white px-4 p-2 rounded-xl bottom-8 centerh"
