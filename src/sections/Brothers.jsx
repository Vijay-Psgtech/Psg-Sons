    ...
    <div className="section h-[100dvh]" onMouseMove={handleMouseMove}>
      <div className="overflow">
        <div className="flex flex-col relative text-center justify-center items-center h-[100dvh] w-full">
          ...
          >
            <p className="text-md toppp tracking-widest -mt-36 uppercase font-semibold">
              Chapter 4
            </p>
            <h1 className="text-5xl toppppp mt-5 font-bold tracking-tighter w-full text-center mx-auto">
              The PSG Brothers
            </h1>
          </motion.div>
          <img
            ...
            width="1905"
            height="552"
            className="absolute bottom-0 drop-shadow-xl z-20 w-5/6 md:w-full centerh"
          ...
          <img
            ...
            width="1000"
            height="1150"
            className="absolute object-contain w-1/2 md:w-1/3  mix-blend-overlay opacity- z-10 origin-bottom centerh bottom-0"
