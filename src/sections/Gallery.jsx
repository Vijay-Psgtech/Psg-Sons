          ...
          >
            <div className="ml-6 sm:ml-12 lg:ml-24 flex h-screen justify-center flex-col items-start shrink-0 w-[16rem] sm:w-[20rem]">
              ...
              <p className="mt-4 lg:mt-6 text-md sm:text-lg w-11/12 mb-36 whitespace-pre-wrap">
                Here is a visual journey showcasing the vibrant life and
                achievements of our educational institutions. Throughout its
                illustrious history, PSG & Sons' Charities has also been honored
                by the presence of distinguished and eminent personalities.
              </p>
