...
const IndustrialTraining = () => {
  ...
  useEffect(() => {
    const handleHashChange = () => {
      if (
        window.location.hash === "#industrial-training" &&
        scrollRef.current
      ) {
          ...
          >
            <div className="ml-6 sm:ml-12 lg:ml-24 flex h-screen justify-center flex-col items-start shrink-0 w-[16rem] sm:w-[20rem]">
              ...
              <p className="mt-4 lg:mt-6 text-md sm:text-lg w-11/12 mb-36 whitespace-pre-wrap">
                At the epicentre of Coimbatore's transformation into the
                industrial and entrepreneurial hub of South India lies in our
                founders's visionary drive. They have invigorated this journey
                by founding training centres that consistently nurture top-tier
                technicians, infusing the region with vitality and expertise.
              </p>
